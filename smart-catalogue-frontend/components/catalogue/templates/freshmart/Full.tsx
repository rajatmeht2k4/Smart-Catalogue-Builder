...
export default function FreshmartFull({
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA]">
            ...
            {/* Hero */}
            <section
                className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 text-white"
                style={{
                    background: `linear-gradient(135deg, ${business.brandColor || "#E53935"
                        }, #8a1f1f)`,
                }}
            >
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-lg sm:text-xl font-semibold text-white/90 max-w-2xl mx-auto">
                            ...
                            return (
                                ...
                                >
                                    <div
                                        ...
                                        style={{ '--tw-ring-color': business.brandColor || "#E53935" } as React.CSSProperties}
                                    >
                                        {/* Checkbox */}
            ...
            <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
                    ...
                    <AnimatePresence>
                        {selected.size > 0 && (
                            <motion.div
                                ...
                                exit={{ scale: 0 }}
                                transition={{ type: "spring", stiffness: 500 }}
                                className="absolute -top-2 -right-2 bg-[#E53935] text-white w-7 h-7 rounded-full flex items-center justify-center text-sm font-black shadow-lg"
                            >
                                {selected.size}
                            </motion.div>
                        )}
                ...
                <motion.a
                    ...
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="relative group bg-white text-gray-900 px-4 py-4 sm:px-6 rounded-2xl font-bold text-base shadow-2xl transition-all flex items-center gap-3 border-2 border-gray-200 hover:border-[#E53935] sm:min-w-[200px] "
                >
                    <MessageSquare className="w-6 h-6" style={{ color: business.brandColor || "#E53935" }} />
